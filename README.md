...
- 鹰角解除了方舟每日签到的风控，改为登岛检票的接口被风控，所以如果仅需要方舟签到的请放心使用，倘若需要登岛检票签到的还请理解。
...
- Codespaces 产生的费用
  ...
  - 对于个人账户（Free 用户）：每月提供 60 个小时的 Codespaces 使用时间，存储空间提供 15GB 免费额度；超出部分的费用（大致）$0.18/小时，存储超出部分：约 $0.07/GB/月。
